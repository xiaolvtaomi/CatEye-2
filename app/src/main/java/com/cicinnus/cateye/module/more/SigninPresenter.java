...
import com.cicinnus.cateye.module.cinema.CinemaManager;
...
/**
 * Created by lml on 18/6/12.
 */

public class SigninPresenter extends BaseMVPPresenter<CinemaContract.ICinemaView> implements CinemaContract.ICinemaPresenter {
    
    private final CinemaManager cinemaManager;
    
    public SigninPresenter(Activity activity, CinemaContract.ICinemaView view) {
        super(activity, view);
