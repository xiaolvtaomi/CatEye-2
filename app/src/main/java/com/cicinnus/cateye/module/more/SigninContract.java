...
public class SigninContract {
    ...
    public interface ICinemaPresenter{
        ...
        void getCinema(int cityId, int offset, int limit, double lat, double lng, int districtId, int areaId, String
                sort,
                       int lineId, int stationId, int brandId, int serviceId, int hallType);

        void getMoreCinema(int cityId, int offset, int limit, double lat, double lng, int districtId, int areaId,
                           String sort,
                           int lineId, int stationId, int brandId, int serviceId, int hallType);
