...
import com.cicinnus.cateye.module.movie.find_movie.awards_movie.awards_list.AwardsListMVPPresenter;
import com.cicinnus.cateye.module.movie.find_movie.awards_movie.awards_list.AwardsSection;
...
public class XueyuanListActivity extends BaseActivity<AwardsListMVPPresenter> implements AwardsListContract.IAwardsListView {
    ...
    public static void start(Context context,boolean isComeFromFindMovie) {
        Intent starter = new Intent(context, XueyuanListActivity.class);
    ...
    protected void initEventAndData() {
        ...
        adapter.setOnAwardsClickListener(new AwardsListAdapter.OnAwardsClickListener() {
            ...
            public void onClick(int festivalId) {
                Intent intent = new Intent(mContext,XueyuanDetailActivity.class);
                intent.putExtra(XueyuanDetailActivity.MOVIE_ID, festivalId);
